...
export const TrainSearchForm: React.FC<TrainSearchFormProps> = ({
  ...
  return (
    <div className="space-y-3 sm:space-y-6 w-full">
      <div className="bg-white/95 backdrop-blur-sm rounded-2xl sm:rounded-3xl shadow-lg shadow-orange-500/5 border border-slate-200/90 p-4 sm:p-6 md:p-8 flex flex-col justify-between relative" id="train-search-card">
      ...
      {hasSearched ? (
        ...
        /* Discovery & Travel Utilities (Popular Routes, Quick PNR, Live Status, Chart Prepared) */
        <TravelUtilities 
