    ...
    <div className="space-y-4 sm:space-y-6 pt-1 pb-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
        ...
        >
          ...
          <div>
            <h4 className="text-xs font-bold text-slate-800 group-hover:text-orange-600">Live Status</h4>
            <p className="text-[10px] text-slate-500 mt-0.5">NTES train tracking</p>
          </div>
        </a>
